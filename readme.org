#+TITLE: EMAX
  ...
  - [[Things for Server User][Things for Server User]]
    - [[Make sure that you setup the %HOME% variable][Make sure that you setup the %HOME% variable]]
      - [[Use the scripts inside tools/windows][Use the scripts inside tools/windows]]
      - [[Windows Task][Windows Task]]
        - [[Create a task in the Task Schedule to be triggered on log on][Create a task in the Task Schedule to be triggered on log on]]
        - [[that task should execute the .vbs file][that task should execute the .vbs file]]
      - [[Launchy][Launchy]]
        - [[Create a shortcut to the launch-client.bat][Create a shortcut to the launch-client.bat]]
        - [[Update icon if you want][Update icon if you want]]
